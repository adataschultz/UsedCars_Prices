...
out_file = 'Xgboost_UsedCars_CarGurus_trials_300.csv'
...
# Access results
results = pd.read_csv('Xgboost_UsedCars_CarGurus_trials_300.csv')
...
# Save model
Pkl_Filename = 'Xgboost_HPO_UsedCars_CarGurus_trials300.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('Xgboost_HPO_UsedCars_CarGurus_trials300.pkl')
# print(model)
# =============================================================================
...
bayes_params.to_csv('bayes_params_Xgboost_HPO_UsedCars_CarGurus_300.csv', 
                    index = False)
...
plt.savefig('UsedCarsCarGurus_Xgboost_HPO_300_FeatureImportance.png',
...
with open(r'D:\UsedCarPrices_CarGurus\ML\ML_Results\NonLinear\Xgboost\best_bayes_UsedCars_CarGurus_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\UsedCarPrices_CarGurus\ML\ML_Results\NonLinear\Xgboostbest_bayes_UsedCars_CarGurus_300_WeightsFeatures.htm'
