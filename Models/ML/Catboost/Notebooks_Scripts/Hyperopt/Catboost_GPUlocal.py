...
path = r'D:\UsedCarPrices_CarGurus\ML\Catboost\trialOptions'
os.chdir(path)
...
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Catboost\Model_PKL'
os.chdir(path)
...
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Catboost\bayesParams'
os.chdir(path)

# Save dataframes of parameters
bayes_params.to_csv('bayes_params_Catboost_HPO_100_GPUlocal.csv', 
                    index = False)
...
###############################################################################
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Catboost\Model_Explanations'
os.chdir(path)
...
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Catboost\bestBayes_WeightsExplain'
os.chdir(path)
