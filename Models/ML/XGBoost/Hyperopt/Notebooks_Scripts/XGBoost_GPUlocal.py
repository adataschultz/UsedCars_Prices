...
out_file = 'XGB_trials_100_GPUlocal.csv'
...
# Access results
results = pd.read_csv('XGB_trials_100_GPUlocal.csv')
...
# Save model
Pkl_Filename = 'XGB_HPO_trials100_GPUlocal.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('XGB_HPO_trials100_GPUlocal.pkl')
# print(model)
# =============================================================================
...
bayes_params.to_csv('bayes_params_XGB_HPO_100_GPUlocal.csv', index=False)
...
plt.savefig('XGB_HPO_100_GPUlocal_FeatureImportance.png',
...
shap.force_plot(explainer.expected_value, shap_values[0,:], X_train.iloc[0,:], 
                show=False, matplotlib=True).savefig('XGB_HPO_100_GPUlocal_ShapForcePlot_TrainSet.png', 
                                                     dpi=my_dpi*10, 
                                                     bbox_inches='tight')

# Training Set: Summarize the effects of all the features
shap.summary_plot(shap_values, X_train, show=False)
fig.savefig('XGB_HPO_100_GPUlocal_ShapSummary_TrainSet.png', dpi=my_dpi*10, 
            bbox_inches='tight')   
...
shap.force_plot(explainer.expected_value, shap_values[0,:], X_test.iloc[0,:], 
                show=False, matplotlib=True).savefig('XGB_HPO_100_GPUlocal_ShapForcePlot_TestSet.png', 
                                                     dpi=my_dpi*10, 
                                                     bbox_inches='tight')     

# Test Set: Summarize the effects of all the features
shap.summary_plot(shap_values, X_test, show=False)
fig.savefig('XGB_HPO_100_GPUlocal_ShapSummary_TestSet.png', dpi=my_dpi*10, 
            bbox_inches='tight')     
...
with open(r'D:\UsedCarsCarGurus\Models\ML\XGBoost\Hyperopt\Model_Explanations\best_bayes_100_GPUlocal_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode('UTF-8'))

# Open the stored feature weights HTML file
url = r'D:\UsedCarsCarGurus\Models\ML\XGBoost\Hyperopt\Model_Explanations\best_bayes_100_GPUlocal_WeightsFeatures.htm'
...
# File to save first results
out_file = 'XGB_trials_300_GPUlocal.csv'
of_connection = open(out_file, 'w')
writer = csv.writer(of_connection)
...
# Access results
results = pd.read_csv('XGB_trials_300_GPUlocal.csv')
...
# Save model
Pkl_Filename = 'XGB_HPO_trials300_GPUlocal.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('XGB_HPO_trials300_GPUlocal.pkl')
# print(model)
# =============================================================================
...
# Save dataframes of parameters
bayes_params.to_csv('bayes_params_XGB_HPO_300_GPUlocal.csv', index=False)
...
# Plot the feature importance from best model result
plot_importance(best_bayes_model, max_num_features=15)
plt.savefig('XGB_HPO_300_GPUlocal_FeatureImportance.png', dpi=my_dpi*10, 
            bbox_inches='tight')
...
fig = plt.figure()
shap.force_plot(explainer.expected_value, shap_values[0,:], X_train.iloc[0,:], 
                show=False, matplotlib=True).savefig('XGB_HPO_300_GPUlocal_ShapForcePlot_TrainSet.png', 
                                                     dpi=my_dpi*10, 
                                                     bbox_inches='tight')

# Training Set: Summarize the effects of all the features
shap.summary_plot(shap_values, X_train, show=False)
fig.savefig('XGB_HPO_300_GPUlocal_ShapSummary_TrainSet.png', dpi=my_dpi*10, 
            bbox_inches='tight')   
...
fig = plt.figure()
shap.force_plot(explainer.expected_value, shap_values[0,:], X_test.iloc[0,:], 
                show=False, matplotlib=True).savefig('XGB_HPO_300_GPUlocal_ShapForcePlot_TestSet.png', 
                                                     dpi=my_dpi*10, 
                                                     bbox_inches='tight')     

# Test Set: Summarize the effects of all the features
shap.summary_plot(shap_values, X_test, show=False)
fig.savefig('XGB_HPO_300_GPUlocal_ShapSummary_TestSet.png', dpi=my_dpi*10, 
            bbox_inches='tight')     
...
# Write feature weights html object to a file 
with open(r'D:\UsedCarsCarGurus\Models\ML\XGBoost\Hyperopt\Model_Explanations\best_bayes_300_GPUlocal_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode('UTF-8'))

# Open the stored feature weights HTML file
url = r'D:\UsedCarsCarGurus\Models\ML\XGBoost\Hyperopt\Model_Explanations\best_bayes_300_GPUlocal_WeightsFeatures.htm'
webbrowser.open(url, new=2)
