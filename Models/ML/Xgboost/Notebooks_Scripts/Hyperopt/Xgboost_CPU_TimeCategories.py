...
path = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\trialOptions'
os.chdir(path)

###############################################################################
#######################  Xgboost HPO CPU local  ###############################
#############################  300 trials   ###################################
###############################################################################
...
out_file = 'Xgboost_trials_300.csv'
...
best_param = fmin(xgb_hpo_cpu, xgb_tune_kwargs, algo=tpe.suggest,
...
# Access results
results = pd.read_csv('Xgboost_trials_300.csv')
...
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_PKL'
os.chdir(path)
...
# Save model
Pkl_Filename = 'Xgboost_HPO_trials300.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('Xgboost_HPO_trials300.pkl')
# print(model)
# =============================================================================
...
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\bayesParams'
os.chdir(path)

# Save dataframes of parameters
bayes_params.to_csv('bayes_params_Xgboost_HPO_300.csv', 
                    index = False)
...
###############################################################################
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations'
os.chdir(path)

# Plot the feature importance from best model result
plot_importance(best_bayes_model, max_num_features = 15)
plt.savefig('Xgboost_HPO_300_FeatureImportance.png',
...
shap.force_plot(explainer.expected_value, shap_values[0,:], X_train.iloc[0,:], 
                show=False, matplotlib=True).savefig('Xgboost_HPO_300_ShapForcePlot_TrainSet.png', 
...
fig.savefig('Xgboost_HPO_100_ShapSummary_TrainSet.png', dpi=my_dpi, 
            bbox_inches='tight')   
...
shap.force_plot(explainer.expected_value, shap_values[0,:], X_test.iloc[0,:], 
                show=False, matplotlib=True).savefig('Xgboost_HPO_300_ShapForcePlot_TestSet.png', 
                                                     dpi=my_dpi, bbox_inches='tight')     
...
fig.savefig('Xgboost_HPO_300_ShapSummary_TestSet.png', dpi=my_dpi, 
            bbox_inches='tight')    
...
with open(r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations\best_bayes_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations\best_bayes_300_WeightsFeatures.htm'
...
# Set path for ML results
path = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\bestBayes_WeightsExplain'
os.chdir(path)
...
# File to save first results
out_file = 'Xgboost_trials_100_GPUlocal.csv'
of_connection = open(out_file, 'w')
writer = csv.writer(of_connection)
...
# Access results
results = pd.read_csv('Xgboost_trials_100_GPUlocal.csv')
...
# Save model
Pkl_Filename = 'Xgboost_HPO_trials100_GPUlocal.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('Xgboost_HPO_trials100_GPUlocal.pkl')
# print(model)
# =============================================================================
...
# Save dataframes of parameters
bayes_params.to_csv('bayes_params_Xgboost_HPO_100_GPUlocal.csv', 
                    index = False)
...
# Plot the feature importance from best model result
plot_importance(best_bayes_model, max_num_features = 15)
plt.savefig('Xgboost_HPO_100_GPUlocal_FeatureImportance.png',
            dpi=my_dpi * 10, bbox_inches='tight')
...
# Write feature weights html object to a file 
with open(r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations\best_bayes_100_GPUlocal_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations\best_bayes_100_GPUlocal_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_100_GPUlocal_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# File to save first results
out_file = 'Xgboost_trials_300_GPUlocal.csv'
of_connection = open(out_file, 'w')
writer = csv.writer(of_connection)
...
# Access results
results = pd.read_csv('Xgboost_trials_300_GPUlocal.csv')
...
# Save model
Pkl_Filename = 'Xgboost_HPO_trials300_GPUlocal.pkl'  
...
# =============================================================================
# # To load saved model
# model = joblib.load('Xgboost_HPO_trials300_GPUlocal.pkl')
# print(model)
# =============================================================================
...
# Save dataframes of parameters
bayes_params.to_csv('bayes_params_Xgboost_HPO_300_GPUlocal.csv', 
                    index = False)
...
# Plot the feature importance from best model result
plot_importance(best_bayes_model, max_num_features = 15)
plt.savefig('Xgboost_HPO_300_GPUlocal_FeatureImportance.png',
            dpi=my_dpi * 10, bbox_inches='tight')
...
# Write feature weights html object to a file 
with open(r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations\best_bayes_300_GPUlocal_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\UsedCarPrices_CarGurus\ML\Xgboost\Model_Explanations\best_bayes_300_GPUlocal_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_300_GPUlocal_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
